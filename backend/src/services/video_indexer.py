...
class video-indexerService:
    def __init__(self):
        self.account_id = os.getenv("AZURE_VI_ACCOUNT_ID")
        self.location = os.getenv("AZURE_VI_LOCATION")
        self.subscription_id = os.getenv("AZURE_SUBSCRIPTION")
        self.resource_group = os.getenv("AZURE_VI_NAME","project-brand-gradian-001") 
        self.credential =DefaultAzureCredential()

    def get_access_token(self):
        "
        GENERATES AN ARM ACCESSS TOKEN "
    ...
    def get_access_token(self,arm_access_token):
